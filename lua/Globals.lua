...
kMarineVariant = enum({ "green", "special", "deluxe", "assault", "eliteassault", "kodiak", "tundra", "anniv" })
kMarineVariantData =
{
...
kSkulkVariant = enum({ "normal", "shadow", "kodiak", "reaper", "abyss", "anniv" })
kSkulkVariantData =
{
...
kGorgeVariant = enum({ "normal", "shadow", "reaper", "anniv" })
kGorgeVariantData =
{
...
kLerkVariant = enum({ "normal", "shadow", "reaper", "anniv" })
kLerkVariantData =
{
...
kFadeVariant = enum({ "normal", "reaper", "shadow", "anniv" })
kFadeVariantData =
{
...
kOnosVariant = enum({ "normal", "reaper", "anniv" })
kOnosVariantData =
{
...
kExoVariant = enum({ "normal", "kodiak", "tundra", "anniv" })
kExoVariantData =
{
...
kRifleVariant = enum({ "normal", "kodiak", "tundra", "red", "anniv" })
kRifleVariantData =
{
...
kPistolVariant = enum({ "normal", "anniv" })
kPistolVariantData = 
{
