...
function GorgeBuild_GetNumStructureBuilt(techId)
    ...
    if ability and (ability:isa("DropStructureAbility") or ability:isa("DropStructureAbility2")) then
...
function GUIGorgeBuildMenu:Reset()
    ...
    for index, structureAbility in ipairs(self.supportedstructures) do
