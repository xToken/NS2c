...
class 'NS2rGamerules' (Gamerules)

NS2rGamerules.kMapName = "ns2r_gamerules"
...
function NS2rGamerules:ChooseTechPoint(techPoints, teamNumber)
...
if Server then
    ...
    NS2rGamerules.kMarineStartSound = PrecacheAsset("sound/ns2c.fev/ns2c/ui/marine_gamestart")
    NS2rGamerules.kAlienStartSound = PrecacheAsset("sound/ns2c.fev/ns2c/ui/alien_gamestart")
    NS2rGamerules.kCountdownSound = PrecacheAsset("sound/NS2.fev/common/countdown")
    ...
    function NS2rGamerules:BuildTeam(teamType)
    ...
    function NS2rGamerules:SetGameState(state)
    ...
    function NS2rGamerules:GetGameTimeChanged()
        return self.timeSinceGameStateChanged
    end

    function NS2rGamerules:GetGameState()
        return self.gameState
    end

    function NS2rGamerules:OnCreate()
    ...
    function NS2rGamerules:OnDestroy()
    ...
    function NS2rGamerules:GetFriendlyFire()
        return false
    end
    
    // All damage is routed through here.
    function NS2rGamerules:CanEntityDoDamageTo(attacker, target)
        return CanEntityDoDamageTo(attacker, target, Shared.GetCheatsEnabled(), Shared.GetDevMode(), self:GetFriendlyFire())
    end
    
    function NS2rGamerules:OnClientDisconnect(client)
    ...
    function NS2rGamerules:OnEntityCreate(entity)
    ...
    function NS2rGamerules:OnEntityDestroy(entity)
    ...
    function NS2rGamerules:OnEntityChange(oldId, newId)

        PROFILE("NS2rGamerules:OnEntityChange")
    ...
    function NS2rGamerules:OnEntityKilled(targetEntity, attacker, doer, point, direction)
    ...
    function NS2rGamerules:LogoutCommanders()
     ...
     */
    function NS2rGamerules:ResetGame()
        ...
        for index, entity in ientitylist(Shared.GetEntitiesWithClassname("Entity")) do
            ...
            // Don't reset/delete NS2rGamerules or TeamInfo.
            // NOTE!!!
            ...
            // at the start of the next game, including the NS2rGamerules. This is how a map transition would have to work anyway.
            ...
            local shieldTypes = { "GameInfo", "MapBlip", "NS2rGamerules" }
    ...
    function NS2rGamerules:GetTeam1()
        return self.team1
    end
    
    function NS2rGamerules:GetTeam2()
        return self.team2
    end
    
    function NS2rGamerules:GetWorldTeam()
        return self.worldTeam
    end
    
    function NS2rGamerules:GetSpectatorTeam()
        return self.spectatorTeam
    end
    
    function NS2rGamerules:GetTeams()
     ...
     */
    function NS2rGamerules:SetHiveTechIdChosen(hive, techId)
    ...
    function NS2rGamerules:UpdateScores()
    ...
    function NS2rGamerules:UpdatePings()
    ...
    function NS2rGamerules:UpdateHealth()
    ...
    function NS2rGamerules:UpdateTechPoints()
    ...
    function NS2rGamerules:CastVoteByPlayer(voteTechId, player)
    ...
    function NS2rGamerules:OnMapPostLoad()
    ...
    function NS2rGamerules:UpdateToReadyRoom()
    ...
    function NS2rGamerules:UpdateMapCycle()
    ...
    function NS2rGamerules:OnUpdate(timePassed)
    
        PROFILE("NS2rGamerules:OnUpdate")
     ...
     */
    function NS2rGamerules:EndGame(winningTeam)
    ...
    function NS2rGamerules:OnTournamentModeEnabled()
        self.tournamentMode = true
        self.sponitor.tournamentMode = true
    end
    
    function NS2rGamerules:OnTournamentModeDisabled()
        self.tournamentMode = false
        self.sponitor.tournamentMode = false
    end
    
    function NS2rGamerules:DrawGame()
    ...
    function NS2rGamerules:GetTeam(teamNum)
    ...
    function NS2rGamerules:GetRandomTeamNumber()
    ...
    function NS2rGamerules:GetCanJoinTeamNumber(teamNumber)
    ...
    function NS2rGamerules:GetCanSpawnImmediately()
     ...
     */
    function NS2rGamerules:JoinTeam(player, newTeamNumber, force)
    ...
    function NS2rGamerules:SetGameStarted()
    ...
    function NS2rGamerules:SetPreventGameEnd(state)
        self.preventGameEnd = state
    end
    
    function NS2rGamerules:SetTeamsReady(ready)
    ...
    function NS2rGamerules:SetPaused()    
    end
    
    function NS2rGamerules:DisablePause()
    end
    
    function NS2rGamerules:CheckGameStart()
    ...
    function NS2rGamerules:CheckGameEnd()
    ...
    function NS2rGamerules:GetCountingDown()
    ...
    function NS2rGamerules:GetPregameLength()
    ...
    function NS2rGamerules:UpdatePregame(timePassed)
        ...
        elseif self:GetGameState() == kGameState.Countdown then
            ...
            if self.lastCountdownPlayed ~= countDownSeconds and (countDownSeconds < 4) then
                ...
                self.worldTeam:PlayPrivateTeamSound(NS2rGamerules.kCountdownSound)
                self.team1:PlayPrivateTeamSound(NS2rGamerules.kCountdownSound)
                self.team2:PlayPrivateTeamSound(NS2rGamerules.kCountdownSound)
                self.spectatorTeam:PlayPrivateTeamSound(NS2rGamerules.kCountdownSound)
            ...
            if self.countdownTime <= 0 then
                ...
                self.team1:PlayPrivateTeamSound(ConditionalValue(self.team1:GetTeamType() == kAlienTeamType, NS2rGamerules.kAlienStartSound, NS2rGamerules.kMarineStartSound))
                self.team2:PlayPrivateTeamSound(ConditionalValue(self.team2:GetTeamType() == kAlienTeamType, NS2rGamerules.kAlienStartSound, NS2rGamerules.kMarineStartSound))
    ...
    function NS2rGamerules:GetLosingTeam()
        return self.losingTeam
    end

    function NS2rGamerules:GetAllTech()
        return self.allTech
    end

    function NS2rGamerules:SetAllTech(state)
    ...
    function NS2rGamerules:GetAutobuild()
        return self.autobuild
    end

    function NS2rGamerules:SetAutobuild(state)
        self.autobuild = state
    end

    function NS2rGamerules:SetOrderSelf(state)
        self.orderSelf = state
    end

    function NS2rGamerules:GetOrderSelf()
        return self.orderSelf
    end

    function NS2rGamerules:GetIsPlayerFollowingTeamNumber(player, teamNumber)
    ...
    function NS2rGamerules:GetCanPlayerHearPlayer(listenerPlayer, speakerPlayer)
    ...
    function NS2rGamerules:RespawnPlayer(player)
    ...
    function NS2rGamerules:BanPlayerFromCommand(playerId)
        ASSERT(type(playerId) == "number")
        table.insertunique(self.bannedPlayers, playerId)
    end

    function NS2rGamerules:GetPlayerBannedFromCommand(playerId)
        ASSERT(type(playerId) == "number")
...
function NS2rGamerules:GetGameStartTime()
    return ConditionalValue(self:GetGameStarted(), self.gameStartTime, 0)
end

function NS2rGamerules:GetGameStarted()
    return self.gameState == kGameState.Started
end

Shared.LinkClassToMap("NS2rGamerules", NS2rGamerules.kMapName, { })
