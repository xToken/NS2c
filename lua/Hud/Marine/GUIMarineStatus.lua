...
function GUIMarineStatus:Initialize()
    ...
    self.ammoText:SetNumberTextAccuracy(1)
    ...
    self.ammoText:SetPosition(Vector(-110, -40, 0))
...
function GUIMarineStatus:Reset(scale)
    ...
    self.ammoText:SetScale(GetScaledVector() * 0.8)
    self.ammoText:SetPosition(Vector(-100, -40, 0))
