...
GUIMarineStatus.kStatusParasiteTexture = PrecacheAsset("ui/alien_hud_health.dds")
...
GUIMarineStatus.kParasiteTimerSize = 118
GUIMarineStatus.kParasiteTimerPosition = Vector( -GUIMarineStatus.kParasiteTimerSize * 0.505, GUIMarineStatus.kParasiteTimerSize * 0.505, 0)
...
function GUIMarineStatus:Initialize()
    ...
    self.parasiteState:SetTexturePixelCoordinates(GUIUnpackCoords(GUIMarineStatus.kParasiteTextureCoords))
...
function GUIMarineStatus:Update(deltaTime, parameters)
    ...
    local regenerationHealth = 0
    local parasitePercentLeft = 100
    ...
    if self.lastParasiteState ~= parasiteState then
        ...
        self.parasiteState:SetColor(GUIMarineStatus.kParasiteColor[parasiteState], 0)
