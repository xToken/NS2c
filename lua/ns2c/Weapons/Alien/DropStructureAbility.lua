...
Script.Load("lua/ns2c/Weapons/Alien/WebsAbility.lua")
Script.Load("lua/ns2c/Weapons/Alien/BabblerEggAbility.lua")
Script.Load("lua/ns2c/Weapons/Alien/CragAbility.lua")
Script.Load("lua/ns2c/Weapons/Alien/ShiftAbility.lua")
Script.Load("lua/ns2c/Weapons/Alien/ShadeAbility.lua")
Script.Load("lua/ns2c/Weapons/Alien/WhipAbility.lua")
Script.Load("lua/ns2c/Weapons/Alien/HarvesterAbility.lua")
Script.Load("lua/ns2c/Weapons/Alien/HiveAbility.lua")
...
local function DropStructure(self, player, origin, direction, structureAbility, lastClickedPosition)
    ...
    if Server then
        ...
        if not LookupTechData(techId, kTechDataAllowConsumeDrop, false) then
            maxStructures = LookupTechData(techId, kTechDataMaxAmount, kMaxGorgeOwnedStructures) 
        end
        
        valid = valid and self:GetNumStructuresBuilt(techId) ~= maxStructures
