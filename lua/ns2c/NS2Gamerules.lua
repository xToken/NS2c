...
if Server then
    ...
    function NS2Gamerules:CheckGameStart()
        ...
        if self:GetGameState() <= kGameState.PreGame then
            ...
            if (((team1Commander or not commRequired) and team2NumPlayer > 0 and team1NumPlayer > 0) or Shared.GetCheatsEnabled()) and (not self.tournamentMode or self.teamsReady) then
