...
kDamageEffects =
{
    ...
    damage_sound =
    {
        damageSounds =
        {
            ...
            {sound = "sound/NS2.fev/materials/door/bash", surface = "door", doer = "Rifle", alt_mode = true, world_space = true, done = true},
            ...
            {sound = "sound/NS2.fev/materials/door/axe", surface = "door", doer = "Axe", world_space = true, done = true},
