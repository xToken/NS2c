...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.Web,         			  [kTechDataMapName] = Web.kMapName,             [kTechDataHint] = kNS2cLocalizedStrings.WEB_HINT, [kTechDataDisplayName] = kNS2cLocalizedStrings.WEB, [kTechDataEngagementDistance] = kWebEngagementRange, [kTechDataMaxHealth] = kWebHealth, [kTechDataMaxArmor] = kWebArmor, [kTechDataModel] = Web.kModelName, [kTechDataPointValue] = kWebPointValue, },
        ...
        { [kTechDataId] = kTechId.Fade,                  [kTechDataMapName] = Fade.kMapName, [kTechDataGestateName] = Fade.kMapName,                       [kTechDataGestateTime] = kFadeGestateTime, [kTechDataDisplayName] = "FADE",   [kTechDataTooltipInfo] = kNS2cLocalizedStrings.FADE_TOOLTIP,         [kTechDataModel] = Fade.kModelName,[kTechDataCostKey] = kFadeCost, [kTechDataMaxHealth] = Fade.kHealth, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataMaxArmor] = Fade.kArmor, [kTechDataMaxExtents] = Vector(Fade.XZExtents, Fade.YExtents, Fade.XZExtents), [kTechDataPointValue] = kFadePointValue},        
