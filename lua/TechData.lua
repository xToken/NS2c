...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.Flamethrower,  [kTechDataAllowStacking] = true,  [kTechDataMapName] = Flamethrower.kMapName, [kTechDataDisplayName] = kNS2cLocalizedStrings.FLAMETHROWER, [kTechDataTooltipInfo] =  kNS2cLocalizedStrings.FLAMETHROWER_TOOLTIP, [kTechDataModel] = Flamethrower.kModelName, [kTechDataCostKey] = kFlamethrowerCost, [kTechDataDamageType] = kFlamethrowerDamageType, [kStructureAttachId] = { kTechId.AdvancedArmory }, [kStructureAttachRange] = kArmoryWeaponAttachRange, [kTechDataCombatCost] = kCombatMarineBaseUpgradeCost },
