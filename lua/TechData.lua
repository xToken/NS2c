...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.HeavyMachineGun,   [kTechDataMapName] = HeavyMachineGun.kMapName, [kTechDataDisplayName] = kNS2cLocalizedStrings.HEAVY_MACHINE_GUN, [kTechDataTooltipInfo] =  kNS2cLocalizedStrings.HEAVY_MACHINE_GUN_TOOLTIP, [kTechDataModel] = HeavyMachineGun.kModelName, [kTechDataCostKey] = kHeavyMachineGunCost, [kTechDataDamageType] = kHeavyMachineGunDamageType, [kStructureAttachId] = { kTechId.AdvancedArmory }, [kStructureAttachRange] = kArmoryWeaponAttachRange},
        ...
        { [kTechDataId] = kTechId.HeavyArmor,   [kTechDataMapName] = HeavyArmor.kMapName, [kTechDataDisplayName] = kNS2cLocalizedStrings.HEAVY_ARMOR, [kTechDataTooltipInfo] =  kNS2cLocalizedStrings.HEAVY_ARMOR_TOOLTIP, [kTechDataModel] = HeavyArmor.kModelName, [kTechDataCostKey] = kHeavyArmorDropCost, [kStructureAttachId] = kTechId.PrototypeLab, [kStructureAttachRange] = kArmoryWeaponAttachRange },
        ...
        { [kTechDataId] = kTechId.Web,                    [kTechDataDisplayName] = kNS2cLocalizedStrings.WEB, [kTechDataHint] = kNS2cLocalizedStrings.WEB_HINT, [kTechDataModel] = Web.kModelName, [kTechDataSpecifyOrientation] = true,  [kTechDataGhostModelClass] = "WebGhostModel", [kTechDataMaxAmount] = kNumWebsPerGorge,  [kTechDataDisplayName] = "WEB", [kTechDataCostKey] = kWebBuildCost, [kTechDataTooltipInfo] = "WEB_TOOLTIP" },        
