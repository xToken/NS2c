...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.Scan,                 [kTechDataIgnorePathingMesh] = true,  [kTechDataAllowStacking] = true, [kTechDataCollideWithWorldOnly] = true, [kTechDataMapName] = Scan.kMapName,     [kTechDataDisplayName] = "SCAN",      [kTechDataHotkey] = Move.S,   [kTechDataCostKey] = kObservatoryScanCost, [kTechDataTooltipInfo] = "SCAN_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.Minigun,               [kTechDataMapName] = Minigun.kMapName,                  [kTechDataDisplayName] = "MINIGUN", [kTechDataDamageType] = kMinigunDamageType, [kTechDataDisplayName] = "MINIGUN_CLAW_TOOLTIP", [kTechDataModel] = Minigun.kModelName},
        { [kTechDataId] = kTechId.Railgun,               [kTechDataMapName] = Railgun.kMapName,                  [kTechDataDisplayName] = "RAILGUN", [kTechDataDamageType] = kRailgunDamageType, [kTechDataDisplayName] = "RAILGUN_CLAW_TOOLTIP", [kTechDataModel] = Railgun.kModelName},
        ...
        { [kTechDataId] = kTechId.HandGrenades,   [kTechDataMapName] = HandGrenades.kMapName, [kTechDataDisplayName] = kNS2cLocalizedStrings.HAND_GRENADES, [kTechDataTooltipInfo] =  kNS2cLocalizedStrings.HAND_GRENADES_TOOLTIP, [kTechDataModel] = HandGrenades.kModelName },
        ...
        { [kTechDataId] = kTechId.Jetpack,  [kTechDataAllowStacking] = true,  [kTechDataMapName] = Jetpack.kMapName, [kTechDataDisplayName] = "JETPACK", [kTechDataTooltipInfo] =  "JETPACK_TOOLTIP", [kTechDataModel] = Jetpack.kModelName, [kTechDataCostKey] = kJetpackDropCost, [kStructureAttachId] = kTechId.PrototypeLab, [kStructureAttachRange] = kArmoryWeaponAttachRange },
        { [kTechDataId] = kTechId.HeavyArmor,  [kTechDataAllowStacking] = true,  [kTechDataMapName] = HeavyArmor.kMapName, [kTechDataDisplayName] = kNS2cLocalizedStrings.HEAVY_ARMOR, [kTechDataTooltipInfo] =  kNS2cLocalizedStrings.HEAVY_ARMOR_TOOLTIP, [kTechDataModel] = HeavyArmor.kModelName, [kTechDataCostKey] = kHeavyArmorDropCost, [kStructureAttachId] = kTechId.PrototypeLab, [kStructureAttachRange] = kArmoryWeaponAttachRange },
        { [kTechDataId] = kTechId.Exosuit,   [kTechDataAllowStacking] = true, [kTechDataMapName] = Exosuit.kMapName, [kTechDataDisplayName] = "EXOSUIT", [kTechDataTooltipInfo] =  "EXOSUIT_TOOLTIP", [kTechDataModel] = Exosuit.kModelName, [kTechDataCostKey] = kExosuitDropCost, [kStructureAttachId] = kTechId.PrototypeLab, [kStructureAttachRange] = kArmoryWeaponAttachRange },
        ...
        { [kTechDataId] = kTechId.ExosuitTech,           [kTechDataCostKey] = kExosuitTechResearchCost,             [kTechDataResearchTimeKey] = kExosuitTechResearchTime},      [kTechDataDisplayName] = "RESEARCH_EXOSUITS", 
        ...
        { [kTechDataId] = kTechId.MotionTracking,        [kTechDataCostKey] = kMotionTrackingResearchCost,          [kTechDataResearchTimeKey] = kMotionTrackingResearchTime,    [kTechDataDisplayName] = kNS2cLocalizedStrings.MOTION_TRACKING,            [kTechDataTooltipInfo] = kNS2cLocalizedStrings.MOTION_TRACKING_TOOLTIP},
        ...
        { [kTechDataId] = kTechId.Metabolize,             [kTechDataMapName] = Metabolize.kMapName,  [kTechDataDisplayName] = kNS2cLocalizedStrings.METABOLIZE, [kTechDataCostKey] = kMetabolizeResearchCost, [kTechDataResearchTimeKey] = kMetabolizeResearchTime, [kTechDataTooltipInfo] = kNS2cLocalizedStrings.METABOLIZE_TOOLTIP},  
        ...
        { [kTechDataId] = kTechId.WhipHive,  [kTechDataHint] = kNS2cLocalizedStrings.WHIP_HIVE_HINT,          [kTechDataMapName] = WhipHive.kMapName,                   [kTechDataDisplayName] = kNS2cLocalizedStrings.WHIP_HIVE, [kTechDataModel] = Hive.kModelName,  [kTechDataHotkey] = Move.V,  [kTechDataMaxHealth] = kHiveHealth,  [kTechDataMaxArmor] = kHiveArmor,     [kStructureAttachClass] = "TechPoint",         [kTechDataSpawnHeightOffset] = kHiveYOffset,     [kTechDataPointValue] = kHivePointValue, [kTechDataTooltipInfo] = "WHIP_HIVE_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.Redemption,         [kTechDataCategory] = kTechId.CragHive,      [kTechDataKeyStructure] = kTechId.Crag,         [kTechDataDisplayName] = kNS2cLocalizedStrings.REDEMPTION, [kTechDataTooltipInfo] = kNS2cLocalizedStrings.REDEMPTION_TOOLTIP, [kTechDataCostKey] = kRedemptionCost },
        ...
        { [kTechDataId] = kTechId.Adrenaline,         [kTechDataCategory] = kTechId.ShiftHive,      [kTechDataKeyStructure] = kTechId.Shift,       [kTechDataDisplayName] = "ADRENALINE", [kTechDataTooltipInfo] = kNS2cLocalizedStrings.ADRENALINE_TOOLTIP, [kTechDataCostKey] = kAdrenalineCost },
        { [kTechDataId] = kTechId.Redeployment,       [kTechDataCategory] = kTechId.ShiftHive,      [kTechDataKeyStructure] = kTechId.Shift,      [kTechDataDisplayName] = kNS2cLocalizedStrings.REDEPLOYMENT, [kTechDataTooltipInfo] = kNS2cLocalizedStrings.REDEPLOYMENT_TOOLTIP, [kTechDataCostKey] = kRedeploymentCost },
        ...
        { [kTechDataId] = kTechId.Aura,               [kTechDataCategory] = kTechId.ShadeHive,      [kTechDataKeyStructure] = kTechId.Shade,       [kTechDataDisplayName] = kNS2cLocalizedStrings.AURA, [kTechDataTooltipInfo] = kNS2cLocalizedStrings.AURA_TOOLTIP, [kTechDataCostKey] = kAuraCost },
        { [kTechDataId] = kTechId.Ghost,              [kTechDataCategory] = kTechId.ShadeHive,      [kTechDataKeyStructure] = kTechId.Shade,      [kTechDataDisplayName] = kNS2cLocalizedStrings.GHOST, [kTechDataTooltipInfo] = kNS2cLocalizedStrings.GHOST_TOOLTIP, [kTechDataCostKey] = kGhostCost },
        ...
        { [kTechDataId] = kTechId.Focus,              [kTechDataCategory] = kTechId.WhipHive,      [kTechDataKeyStructure] = kTechId.Whip,    [kTechDataDisplayName] = kNS2cLocalizedStrings.FOCUS, [kTechDataTooltipInfo] = kNS2cLocalizedStrings.FOCUS_TOOLTIP, [kTechDataCostKey] = kFocusCost },
        { [kTechDataId] = kTechId.Fury,               [kTechDataCategory] = kTechId.WhipHive,      [kTechDataKeyStructure] = kTechId.Whip,    [kTechDataDisplayName] = kNS2cLocalizedStrings.FURY, [kTechDataTooltipInfo] = kNS2cLocalizedStrings.FURY_TOOLTIP, [kTechDataCostKey] = kFuryCost },
        { [kTechDataId] = kTechId.Bombard,            [kTechDataCategory] = kTechId.WhipHive,      [kTechDataKeyStructure] = kTechId.Whip,    [kTechDataDisplayName] = kNS2cLocalizedStrings.BOMBARD, [kTechDataTooltipInfo] = kNS2cLocalizedStrings.BOMBARD_TOOLTIP, [kTechDataCostKey] = kBombardCost },
